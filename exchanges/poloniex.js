...
Trader.getCapabilities = function () {
  return {
    ...
    assets: [
      ...
      'SLR', 'SMC', 'SOC', 'SPA', 'SQL', 'SRCC', 'SRG', 'SSD', 'STEEM', 'STR', 'STRAT','STORJ',
    ...
    markets: [
      ...
      { pair: ['BTC', 'STORJ'], minimalOrder: { amount: 0.0001, unit: 'asset' } },
      { pair: ['BTC', 'STRAT'], minimalOrder: { amount: 0.0001, unit: 'asset' } },
